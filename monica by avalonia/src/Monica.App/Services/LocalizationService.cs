...
public sealed class LocalizationService : ILocalizationService
{
    ...
    private static readonly Dictionary<string, string> English = new()
    {
        ...
        ["WindowCaptureProtectionDescription"] = "Screenshot and screen-recording protection is unavailable on Linux; the compositor does not expose a desktop-equivalent capture block.",
        ...
        ["DesktopBackgroundBehaviorDescription"] = "Decide whether Monica remains available from the system tray after its window closes.",
        ["DesktopQuickAccess"] = "Quick access",
        ["DesktopQuickAccessDescription"] = "Open Monica from anywhere with a system-wide shortcut when the desktop environment supports global hotkeys.",
        ...
        ["DesktopTrayActiveStatus"] = "Monica remains available from the system tray when its window is closed.",
    ...
    private static readonly Dictionary<string, string> Chinese = new()
    {
        ...
        ["WindowCaptureProtectionDescription"] = "Linux 桌面暂不提供与系统等价的截图/录屏屏蔽；该开关按平台能力保持不可用。",
        ...
        ["Desktop"] = "桌面",
        ["DesktopSettingsDescription"] = "设置 Monica 在 Linux 桌面托盘驻留、全局唤起、浏览器配对以及桌面空间利用方式。",
        ["DesktopBackgroundBehavior"] = "桌面后台行为",
        ["DesktopBackgroundBehaviorDescription"] = "决定关闭窗口后是否仍从系统托盘保留 Monica 入口。",
        ["DesktopQuickAccess"] = "快速访问",
        ["DesktopQuickAccessDescription"] = "在桌面环境支持全局快捷键时，通过系统级快捷键从其他应用随时唤起 Monica。",
